...
public class RotateWorld : MonoBehaviour {
	...
	void LookWorld(){
		...
		LookVertical();
		Debug.Log("anglesfromUp" + anglesFromRotateUp);
		Debug.Log ("actualAnglesUp" + actualUpRotation);
		LookHorizontal();
		Debug.Log("anglesfromFor" + anglesFromRotate);
		Debug.Log ("actualAngles" + actualForwardRotation);
		SetRotation ();
	}
